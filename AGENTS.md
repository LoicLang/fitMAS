...
Current state and next tranche: `docs/BUILD-ORDER.md` (single status source).

Proof doctrine:

- "Better" is failure-profile-first: V0 must fail **safe** where the app failed **dangerous**. Never game a raw rate.
