...
def test_adapter_runs_decision_service_for_requested_change(monkeypatch) -> None:
    ...
    monkeypatch.setattr("fitmas.legacy.decision.planning_runtime.decide_plan_change", fake_decide_plan_change)
...
def test_adapter_applies_command_service_for_planning_decision(monkeypatch) -> None:
    ...
    monkeypatch.setattr("fitmas.legacy.decision.planning_runtime.decide_plan_change", fake_decide_plan_change)
    monkeypatch.setattr("fitmas.legacy.decision.planning_runtime.PlanningCommandService", FakeCommandService)
