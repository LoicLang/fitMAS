...
from fitmas.api_payloads import OnboardPreviewPayload
from fitmas.api_support import build_onboarding_facts, normalized_onboarding_payload
...
class OnboardingContractTest(unittest.TestCase):
    ...
    def test_preview_endpoint_returns_setup_preview(self) -> None:
        ...
        with (
            patch("fitmas.api_onboarding.formulate_onboarding_recap", return_value="recap"),
            patch("fitmas.api_onboarding.preview_coach_voice", return_value=["a", "b", "c"]),
        ):
