...
from fitmas.legacy.llm.gateway import client, request_text, request_json, request_message, message_text, message_json
...
from fitmas.legacy.llm.prompts.layers import assemble_layered_prompt, build_identity_layer
...
from fitmas.legacy.domain.planning.mutation_hooks import (
    PreMutationResult,
...
from fitmas.legacy.tools.contract import ToolCall, ToolContext, ToolResult
from fitmas.legacy.tools.runtime import execute_tool_call
from fitmas.legacy.core.time_context import build_time_context
