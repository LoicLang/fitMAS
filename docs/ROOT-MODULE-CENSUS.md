...
| `repository.py` | core | keep_root_temporarily | planning session/audit repository extracted; remaining memory, execution, athlete and template DB helpers need domain facades | repository split continuation |
