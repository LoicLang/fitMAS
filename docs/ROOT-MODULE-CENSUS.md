...
| `repository.py` | core | keep_root_temporarily | planning and memory repositories extracted; remaining execution, athlete and template DB helpers need domain facades | repository split continuation |
