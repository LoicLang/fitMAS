...
Fait le 5 juin : **Slice 0, 1, 1.5, 2.0** (specs `2026-06-05-moteur-sport-*`, design `2026-06-05-slice-2-0-voie-b-design.md`). Fait le 6 juin : **Slice 2.1** (générateur LLM-first, template filet, anti-drop contrainte-aware Tier 2, offline ; harness `scripts/v0_eval/generate_weeks.py`). Suite : **Slice 3** (tool runtime `propose_week` coach-callable).
