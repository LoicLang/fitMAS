...
_PROMPT_CONTRACTS: dict[str, PromptContract] = {
    ...
    "conversation_availability_constraint": PromptContract(
        name="conversation_availability_constraint",
        capability="write_after_validation",
        allowed_tools=(
            "resolve_planning_window",
            "get_plan_window",
        ...
        allowed_actions=("record_availability", "pending_resolution"),
        required_truth_blocks=("temporal", "planning", "working_memory"),
        optional_truth_blocks=("execution_reality", "active_thread", "pending_confirmation"),
        decision_output_schema="CoachDecision",
        output_schema="CoachDecision",
        final_reply_mode="post_runtime",
        max_context_blocks=("temporal", "planning", "working_memory", "active_thread", "pending_confirmation"),
    ),
