...
from fitmas.legacy.domain.execution.helpers import (
...
from fitmas.legacy.domain.coaching.calibration_needs import CalibrationNeedType, looks_like_clarification_message
from fitmas.legacy.domain.coaching.coach_reading_digest import CoachReadingDigest, build_coach_reading_facts
...
import fitmas.legacy.llm.reply_backend as reply_backend
from fitmas.legacy.domain.execution.clarification import build_execution_clarification
from fitmas.legacy.decision.grounding import ReplyGroundingPacket, plan_window_facts_from_sessions
from fitmas.legacy.skills.heartbeat import evaluation as heartbeat_evaluation
from fitmas.legacy.skills.heartbeat import reply_composer as heartbeat_reply
from fitmas.legacy.skills.heartbeat.context import build_heartbeat_context_bundle
from fitmas.legacy.skills.heartbeat.reply_context import (
...
from fitmas.legacy.knowledge import load_sport_knowledge
from fitmas.legacy.llm.gateway import generate_heartbeat_text, generate_heartbeat_text_with_debug, request_text
from fitmas.legacy.llm.prompts.conversation_builder import detect_open_question
from fitmas.legacy.domain.planning.mutation_permissions import default_confirmation_expiry, serialize_plan_patch_confirmation
from fitmas.legacy.domain.planning.plan_patch import PlanPatch, PlanPatchValidation, plan_patch_from_mutation_decisions, validate_plan_patch
...
from fitmas.legacy.skills.heartbeat.tool_loop import (
    generate_heartbeat_text_with_tools_debug,
    heartbeat_read_tools_enabled,
)
from fitmas.legacy.core.time_context import build_time_context, get_local_now
...
def signal_check() -> CoachDraft | None:
    ...
    try:
        ...
        try:
            from fitmas.legacy.domain.planning.adaptation import check_and_adapt_tsb, check_and_adapt_missed
