...
from fitmas.legacy.domain.coaching.calibration_status import build_calibration_status
from fitmas.legacy.app.telegram.delivery import CoachDraft
from fitmas.legacy.domain.coaching.coach_reading_digest import CoachReadingDigest, render_digest_for_prompt
...
from fitmas.legacy.domain.memory.fact_memory import fact_is_current
from fitmas.legacy.knowledge import load_sport_knowledge
from fitmas.legacy.domain.planning.contract import build_availability_state
...
from fitmas.legacy.core.time_context import DAY_LABELS_FR, build_time_context, get_local_now, render_time_context
