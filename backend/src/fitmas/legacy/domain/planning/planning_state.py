...
from fitmas.legacy.domain.athlete.zones import AthleteZones, build_athlete_zones
from fitmas.legacy.domain.athlete.fitness_snapshot import FitnessSnapshot, build_fitness_snapshot
from fitmas.legacy.domain.planning import repository as planning_repo
from fitmas.legacy.domain.planning.planning_decision import PlanningDecision, build_planning_decision
