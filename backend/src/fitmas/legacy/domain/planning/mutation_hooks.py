...
from fitmas.legacy.domain.planning.planning_config import GLOBAL_PLANNING_CONFIG, get_sport_planning_config
from fitmas.legacy.domain.planning.session_similarity import find_same_sport_proximity_conflict
