...
from fitmas.legacy.domain.athlete.zones import AthleteZones
from fitmas.legacy.domain.planning.validator import validate_week_plan
from fitmas.legacy.domain.planning.planning_config import get_sport_planning_config
from fitmas.legacy.domain.planning.planning_decision import PlanningDecision
from fitmas.legacy.domain.planning.session_templates import render_session_description, select_session_template
...
def _resolve_interference(day_list: list[dict]) -> None:
    ...
    from fitmas.legacy.domain.planning.interference import check_adjacent_conflicts
...
def _session_note(session: PlannedSession, *, planning_decision: PlanningDecision | None) -> str:
    ...
    from fitmas.legacy.domain.athlete.load_projection import planning_mode_label_fr
