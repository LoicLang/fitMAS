...
from fitmas.legacy.domain.planning.plan_patch import PlanPatch, PlanPatchValidation, validate_plan_patch
from fitmas.legacy.domain.planning.candidates import (
