...
from fitmas.legacy.domain.planning.intensity_distribution import check_distribution
from fitmas.legacy.domain.planning.planning_config import get_global_planning_config, get_sport_planning_config
