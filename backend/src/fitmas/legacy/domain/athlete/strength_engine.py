...
from fitmas.legacy.domain.athlete.strength_exercise_bank import StrengthExercise, list_strength_exercises
from fitmas.legacy.domain.athlete.strength_signals import StrengthSignals, derive_strength_signals
