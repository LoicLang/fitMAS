...
from fitmas.legacy.domain.planning.periodization import compute_mesocycle_state
...
from fitmas.legacy.domain.planning.periodization import build_week_label
