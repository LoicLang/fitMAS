...
from fitmas.legacy.domain.execution.claims import extract_claims_from_facts
from fitmas.legacy.domain.execution.helpers import activities_on_local_date, claimed_activities_on_local_date
from fitmas.legacy.domain.planning import repository as planning_repo
from fitmas.legacy.core.time_context import DAY_KEYS, DAY_LABELS_FR, build_time_context, get_local_now, get_timezone, hours_since, utc_cutoff
