...
from fitmas.legacy.domain.athlete.profile import AthleteProfileSnapshot, build_athlete_profile
from fitmas.legacy.domain.coaching.calibration_status import CalibrationStatus, build_calibration_status
from fitmas.legacy.domain.planning.contract import (
    AvailabilityState,
    PlanningContract,
    SessionPolicy,
    WeekMission,
...
from fitmas.legacy.domain.execution.recent_reality import RecentRealityWindow, build_recent_reality_window
from fitmas.legacy.domain.coaching.week_context import (
