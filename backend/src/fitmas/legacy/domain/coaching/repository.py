...
from fitmas.legacy.domain.coaching.adaptation_log import AdaptationLogEntry, _impact_label, _mission_label, _reason_label
from fitmas.legacy.domain.planning.adaptation_decision import DecisionReasonCode, TrajectoryImpact, WeekMissionStatus
