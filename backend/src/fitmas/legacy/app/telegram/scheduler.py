...
from fitmas.legacy.app.telegram.shared import (
...
def _reserve_heartbeat_guard_after_send() -> None:
    from fitmas.legacy.core.db import SessionLocal
    from fitmas.legacy.skills.heartbeat.heartbeat import _reserve_module_guard
...
async def weekly_review_cron(context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        from fitmas.legacy.skills.heartbeat.heartbeat import weekly_review
...
async def send_morning_briefing(context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        from fitmas.legacy.skills.heartbeat.heartbeat import morning_briefing
...
async def send_pre_session_reminder(context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        from fitmas.legacy.skills.heartbeat.heartbeat import pre_session_reminder
