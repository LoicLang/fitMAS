...
from fitmas.legacy.app.telegram.commands import register_command_handlers
from fitmas.legacy.app.telegram.onboarding import build_onboarding_handler
from fitmas.legacy.app.telegram.scheduler import register_jobs
