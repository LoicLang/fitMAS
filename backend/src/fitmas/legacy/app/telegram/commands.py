...
from fitmas.legacy.app.telegram.api import api_get, api_post
from fitmas.legacy.app.telegram.debounce import (
    build_batched_text,
...
from fitmas.legacy.app.telegram.shared import DAY_LABELS, SPORT_EMOJIS, persist_draft_for_owner
