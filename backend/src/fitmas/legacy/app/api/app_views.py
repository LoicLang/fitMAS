...
from fitmas.legacy.core.calendar_resolution import build_session_item, resolve_calendar_payload
from fitmas.legacy.domain.athlete.fitness_snapshot import estimate_scheduled_session_tss
from fitmas.legacy.domain.athlete.load_projection import build_load_forecast, planning_mode_label_fr
