...
from fitmas.legacy.app.api.payloads import ManualActivityPayload
from fitmas.legacy.app.api.support import parse_optional_datetime, public_base_url
from fitmas.legacy.core.db import get_db
from fitmas.legacy.domain.execution.view_models import Activity
from fitmas.legacy.domain.planning.patch_mutation_service import complete_session_from_activity_for_user
