...
from fitmas.legacy.app.api.payloads import OnboardPayload, OnboardPreviewPayload
from fitmas.legacy.app.api.support import apply_onboarding_to_user, build_onboarding_facts, normalized_onboarding_payload
from fitmas.legacy.domain.coaching.calibration_status import build_calibration_status, build_initial_calibration_status
from fitmas.legacy.core.db import get_db
from fitmas.legacy.domain.coaching.generated_week_coherence import GeneratedWeekCoherenceBlocked, guard_generated_week_coherence
import fitmas.legacy.llm.gateway as gw
from fitmas.legacy.llm.legacy_onboarding import (
    formulate_onboarding_recap,
    formulate_week_plan,
    preview_coach_voice,
)
from fitmas.legacy.domain.memory.profile_memory import replace_profile_memory
from fitmas.legacy.app.api.onboarding_models import OnboardPreview, OnboardResult
from fitmas.legacy.domain.planning.view_models import WeeklyPlan
from fitmas.legacy.app.api.onboarding_contract import build_goal_summary, build_onboarding_setup_preview, build_protected_focus
from fitmas.legacy.domain.planning.periodization import compute_mesocycle_state, derive_total_weeks
from fitmas.legacy.domain.planning.planner import build_week_plan
from fitmas.legacy.domain.planning.planning_state import refresh_planning_state
