...
from fitmas.legacy.app.api.support import ensure_debug_enabled
...
from fitmas.legacy.skills.heartbeat.runtime_adapter import heartbeat_runtime_payload, run_heartbeat_endpoint, run_heartbeat_trigger
from fitmas.legacy.app.telegram.channel import resolve_chat_id, send_text_message
