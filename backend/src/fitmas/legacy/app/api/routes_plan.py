...
from fitmas.legacy.app.api.payloads import MoveSessionPayload
from fitmas.legacy.domain.planning.view_models import ScheduledSession
from fitmas.legacy.domain.planning.patch_mutation_service import complete_session_for_user, move_session_for_user, skip_session_for_user
