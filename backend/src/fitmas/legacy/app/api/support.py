...
from fitmas.legacy.app.api.onboarding_contract import build_coach_profile, build_goal_summary
from fitmas.legacy.domain.planning.planner import normalize_sports
