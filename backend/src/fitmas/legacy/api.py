...
from fitmas.legacy.app.api.routes_ops import router as ops_router
from fitmas.legacy.app.api.routes_messages import router as messages_router
from fitmas.legacy.app.api.routes_onboarding import router as onboarding_router
from fitmas.legacy.app.api.routes_plan import router as plan_router
