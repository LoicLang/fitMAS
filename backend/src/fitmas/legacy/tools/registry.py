...
from fitmas.legacy.domain.memory.fact_memory import fact_is_current, select_relevant_facts
from fitmas.legacy.domain.planning.window_resolution import format_planning_window_summary, resolve_planning_window_inputs
from fitmas.legacy.tools.replan_proposal import build_replan_proposal
from fitmas.legacy.core.time_context import get_local_now, get_timezone
from fitmas.legacy.tools.contract import ToolContext, ToolResult, ToolSpec
...
def _validate_week_coherence_tool(context: ToolContext, arguments: dict[str, Any]) -> ToolResult:
    from fitmas.legacy.domain.planning.plan_patch import PlanPatch, validate_plan_patch
    from fitmas.legacy.domain.planning.week_coherence import aggregate_week_coherence_policy, build_week_coherence_context
...
def _request_week_coherence_json(**kwargs) -> dict[str, Any] | None:
    from fitmas.legacy.domain.planning.patch_mutation_service import _request_week_coherence_json as request_json

    return request_json(**kwargs)


def review_week_coherence_with_llm(context: Any, *, request_json_fn: Any = None) -> Any:
    from fitmas.legacy.domain.planning.week_coherence import review_week_coherence_with_llm as review
