...
def init_db() -> None:
    from fitmas.legacy.core import orm  # noqa: F401 - registers all ORM models with Base
...
def _ensure_sqlite_columns() -> None:
    ...
    migrations = {
        ...
        "weekly_plans": [
            ...
            ("total_weeks", "ALTER TABLE weekly_plans ADD COLUMN total_weeks INTEGER DEFAULT 1"),
        ],
        "day_plans": [
        ...
        "user_facts": [
            ...
            ("status", "ALTER TABLE user_facts ADD COLUMN status VARCHAR(16) DEFAULT 'open'"),
            ("severity", "ALTER TABLE user_facts ADD COLUMN severity VARCHAR(16) DEFAULT 'medium'"),
            ("signal_kind", "ALTER TABLE user_facts ADD COLUMN signal_kind VARCHAR(32) DEFAULT ''"),
            ("observed_at", "ALTER TABLE user_facts ADD COLUMN observed_at DATETIME"),
            ("valid_from", "ALTER TABLE user_facts ADD COLUMN valid_from DATETIME"),
            ("valid_until", "ALTER TABLE user_facts ADD COLUMN valid_until DATETIME"),
            ("last_seen_at", "ALTER TABLE user_facts ADD COLUMN last_seen_at DATETIME"),
            ("resolved_at", "ALTER TABLE user_facts ADD COLUMN resolved_at DATETIME"),
            ("resolution_reason", "ALTER TABLE user_facts ADD COLUMN resolution_reason TEXT DEFAULT ''"),
        ],
        "working_memory_entries": [
            ("status", "ALTER TABLE working_memory_entries ADD COLUMN status VARCHAR(16) DEFAULT 'open'"),
            ("severity", "ALTER TABLE working_memory_entries ADD COLUMN severity VARCHAR(16) DEFAULT 'medium'"),
            ("signal_kind", "ALTER TABLE working_memory_entries ADD COLUMN signal_kind VARCHAR(32) DEFAULT ''"),
            ("observed_at", "ALTER TABLE working_memory_entries ADD COLUMN observed_at DATETIME"),
            ("valid_from", "ALTER TABLE working_memory_entries ADD COLUMN valid_from DATETIME"),
            ("valid_until", "ALTER TABLE working_memory_entries ADD COLUMN valid_until DATETIME"),
            ("last_seen_at", "ALTER TABLE working_memory_entries ADD COLUMN last_seen_at DATETIME"),
            ("resolved_at", "ALTER TABLE working_memory_entries ADD COLUMN resolved_at DATETIME"),
            ("resolution_reason", "ALTER TABLE working_memory_entries ADD COLUMN resolution_reason TEXT DEFAULT ''"),
        ],
        "coach_messages": [
