...
from fitmas.legacy.domain.execution.clarification import render_unresolved_execution_followup
from fitmas.legacy.decision.grounding import (
    ReplyGroundingPacket,
    render_grounding_packet_for_prompt,
)
from fitmas.legacy.decision.turn_context_payload import (
    build_reply_grounding_packet,
    fact_identity,
    turn_plan_payload,
)
from fitmas.legacy.decision.turn_prompt_context import (
...
from fitmas.legacy.domain.memory.profile_summary import build_profile_summary
