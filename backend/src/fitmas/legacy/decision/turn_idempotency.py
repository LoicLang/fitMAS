...
from fitmas.legacy.decision.conversation_contract import ConversationTurnInput, ConversationTurnOutcome
from fitmas.legacy.decision.message_models import Extraction, Message, MessageReply, MessageRole
