...
from fitmas.legacy.domain.execution.context import (
    TodayExecutionContext,
    build_today_execution_context,
    format_execution_context_for_prompt,
)
from fitmas.legacy.domain.memory.fact_memory import normalize_fact_payload, select_relevant_facts
from fitmas.legacy.domain.coaching.signals import Signal, format_signals_for_prompt, select_conversation_signals
from fitmas.legacy.core.temporal_resolver import (
    TemporalResolution,
